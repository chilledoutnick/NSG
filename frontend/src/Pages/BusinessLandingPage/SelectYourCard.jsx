...
const SelectYourCard = () => {
  ...
  const handlePersonalize = () => {
    // ✅ pehle existing order lo
    const existingOrder = JSON.parse(localStorage.getItem("order")) || {};

    const order = {
      ...existingOrder,
      metal_card: selected,
      metal_price: currentPlan.discountedPrice,
      original_price: currentPlan.originalPrice,
    };
      ...
      <div className="card-width">
        <div className="card-content">
          ...
          <div className="cta-fixed">
            <button className="primaryy-btn" onClick={handlePersonalize}>
